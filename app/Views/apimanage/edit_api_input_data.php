<div class="row" style="margin-top: 30px;">
    <div class="col-md-12">
        <form method="post" action="<?=site_url('api/ApiManage/api_input_edit')?>" id="frm_api_input_edit">
...
<form class="hidden" method="get" action="<?=site_url('api/ApiManage/api_input_list')?>" id="frm_go_api_input_list">
    <input class="hidden" name="id" value="<?=$api_idx?>">
</form>
<script>
    $(document).ready(function(){
        $('#menu_api_mng').addClass('active');
        $('#page_title').html("<?= t('add_input_variable') ?>");
