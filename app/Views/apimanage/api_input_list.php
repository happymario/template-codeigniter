    ...
    <div class="col-md-12">
        <div class="col-md-12">
            <div class="btn-group"  style="float: right;margin-top: 20px;">
                ...
                <a type="button" class="btn btn-success" style="font-size: 13px;" href="<?=site_url('api/ApiManage/api_output_list')?>?id=<?=$api_idx?>"><?= t('go_output_list') ?></a>
                <a type="button" class="btn btn-primary" style="font-size: 13px;" href="<?=site_url('api/ApiManage/edit_api_input_data')?>?ai_idx=0&api_idx=<?=$api_idx?>"><i class="fa fa-plus"></i>&nbsp;<?= t('add_input_variable') ?></a>
            </div>
        </div>
    </div>
...
<script>
    ...
    $("#btnMultiDel").click(function () {
        ...
        $.ajax({
            type:'post',
            url:'<?=site_url("api/ApiManage/delete_api_input_data")?>',
    ...
    function drawTable(){
        $.ajax({
            type:'post',
            url:'<?=site_url("api/ApiManage/draw_api_input_list")?>',
