        ...
        <div class="row gx-5 gx-xl-10">
            ...
            <div class="col-xxl-12 mb-5 mb-xl-10">
                ...
                <div class="card card-flush h-xl-100">
                    ...
                    <div class="card-header py-7">
                        ...
                        <div class="m-0">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                <a style="font-weight: bold;font-size: 16px;" href="<?=base_url("admin/Statistic")?>">ChartJS <?= t('statistic') ?></a>
                    ...
                    <!--end::Header-->
                    <!--begin::Body-->
                    <div class="card-body pt-0 pb-1 mb-10">
                        <div class="row gx-5 gx-xl-10">
                            <div class="col-xxl-6">
                                <canvas id="myChart"></canvas>
                            </div>
                            <div id="kt_charts_widget_27" class="col-xxl-6 min-h-auto">
                                ...
                                <div class="col-md-12" style="text-align: center">
                                    <svg width="180" height="30">
                                        <g>
                                            ...
                                            <text x="22" y="15" font-family="Verdana" font-size="14" fill="#3185FC"
                                                  class="last2month">
                                                3<?= t('month') ?></text>
                                        </g>
                                        ...
                                        <g>
                                            ...
                                            <text x="82" y="15" font-family="Verdana" font-size="14" fill="#ff8c00"
                                                  class="lastmonth">
                                                4<?= t('month') ?></text>
                                        </g>
                                        ...
                                        <g>
                                            ...
                                            <text x="142" y="15" font-family="Verdana" font-size="14" fill="#8a89a6"
                                                  class="curmonth">
                                                5<?= t('month') ?></text>
                                        </g>
                                    </svg>
                            ...
                            <div style="flex: 1;">
                                ...
                                <div class="col-md-12" style="text-align: center">
                                    <svg width="320" height="30">
                                        <g>
                                            <rect x="0" y="0" width="20" height="20" fill="#3185FC"></rect>
                                            <text x="22" y="15" font-family="Verdana" font-size="14"
                                                  fill="#3185FC"><?= t('team') ?>1
                                            </text>
                                        </g>

                                        <g>
                                            <rect x="80" y="0" width="20" height="20" fill="#ff8c00"></rect>
                                            <text x="102" y="15" font-family="Verdana" font-size="14"
                                                  fill="#ff8c00"><?= t('team') ?>2
                                            </text>
                                        </g>

                                        <g>
                                            <rect x="160" y="0" width="20" height="20" fill="#8a89a6"></rect>
                                            <text x="182" y="15" font-family="Verdana" font-size="14"
                                                  fill="#8a89a6"><?= t('team') ?>3
                                            </text>
                                        </g>

                                        <g>
                                            <rect x="240" y="0" width="20" height="20" fill="#ff2200"></rect>
                                            <text x="262" y="15" font-family="Verdana" font-size="14"
                                                  fill="#ff2200"><?= t('team') ?>4
                                            </text>
                                        </g>
                                    </svg>
                                </div>
