(function (g, e, b, j, c, i, k) {/*! Jssor */
    ...
    var a = new function () {
        var f = this, zb = /\S+/g, S = 1, fb = 2, jb = 3, ib = 4, nb = 5, I, s = 0, l = 0, q = 0, J = 0, C = 0,
            y = navigator, sb = y.appName, n = y.userAgent;
        ...
        function t(i) {
            if (!s) {
                ...
                if (sb == "Microsoft Internet Explorer" && !!g.attachEvent && !!g.ActiveXObject) {
                    ...
                    var d = n.indexOf("Firefox"), b = n.indexOf("Safari"), h = n.indexOf("Chrome"),
        ...
        function Bb(g, a, i) {
            if (!J || J < 9) {
                ...
                var m = g.style.filter, n = new RegExp(/[\s]*progid:DXImageTransform\.Microsoft\.Matrix\([^\)]*\)/g),
                    l = F(m, [n], h);
                eb(g, l)
            }
        }
        ...
        f.Og = function (d, c, a) {
            var e = D.Ub(d, w(-c / 2, -a / 2)), f = D.Ub(d, w(c / 2, -a / 2)), g = D.Ub(d, w(c / 2, a / 2)),
                h = D.Ub(d, w(-c / 2, a / 2));
    ...
    var o = g.$JssorSlideshowFormations$ = new function () {
        var h = this, d = 0, a = 1, f = 2, e = 3, s = 1, r = 2, t = 4, q = 8, w = 256, x = 512, v = 1024, u = 2048,
        ...
        h.$FormationSwirl = function (q) {
            var x = q.$Cols, y = q.$Rows, B = q.$Assembly, w = q.hc, A = [], z = [], u = 0, b = 0, h = 0, r = x - 1,
                s = y - 1, t, p, v = 0;
            switch (B) {
                case j:
                    b = r;
        ...
        h.$FormationZigZag = function (p) {
            var w = p.$Cols, x = p.$Rows, z = p.$Assembly, v = p.hc, t = [], u = 0, b = 0, c = 0, q = w - 1, r = x - 1,
                y, h, s = 0;
            switch (z) {
                case j:
                    b = q;
        ...
        h.$FormationStraightStairs = function (q) {
            var u = q.$Cols, v = q.$Rows, e = q.$Assembly, t = q.hc, r = [], s = 0, c = 0, d = 0, f = u - 1, h = v - 1,
                x = t - 1;
            switch (e) {
                case j:
                case m:
    ...
    g.$JssorSlideshowRunner$ = function (n, s, q, t, y) {
        ...
        function p(A, h, d, v, n, l) {
            var y = this, t, u = {}, j = {}, m = [], f, e, r, p = d.$ChessMode.$Column || 0, q = d.$ChessMode.$Row || 0,
                g = d.ie(n, l), o = B(d), C = o.length - 1, s = d.$Duration + d.$Delay * C, w = v + s, k = d.$SlideOut,
                x;
            w += 50;
            ...
            a.c(o, function (h, m) {
                a.c(h, function (G) {
                    ...
                    var C = s ? d.$Bottom : d.$Top, z = s ? d.$Top : d.$Bottom, B = o ? d.$Right : d.$Left,
                        A = o ? d.$Left : d.$Right;
                    d.$Clip = C || z || B || A;
                    r = {};
    ...
    var h = g.$JssorSlider$ = function (q, fc) {
        ...
        var gb = f.$PlayOrientation & 3, wc = (f.$PlayOrientation & 4) / -4 || 1, db = f.$SlideshowOptions,
            I = a.p({$Class: p, $PlayInMode: 1, $PlayOutMode: 1}, f.$CaptionSliderOptions);
        I.$Transitions = I.$Transitions || I.$CaptionTransitions;
        var qb = f.$BulletNavigatorOptions, W = f.$ArrowNavigatorOptions, ab = f.$ThumbnailNavigatorOptions,
            Q = !f.$UISearchMode, y, v = a.D(q, "slides", Q), cb = a.D(q, "loading", Q) || a.mb(e),
            Jb = a.D(q, "navigator", Q), cc = a.D(q, "arrowleft", Q), ac = a.D(q, "arrowright", Q),
            Hb = a.D(q, "thumbnavigator", Q), nc = a.l(v), mc = a.m(v), V, T = [], xc = a.O(v);
        a.c(xc, function (b) {
            if (b.tagName == "DIV" && !a.j(b, "u")) T.push(b); else a.V() && a.J(b, (a.J(b) || 0) + 1)
        });
        var s = -1, yb, tb, r = T.length, K = f.$SlideWidth || nc, J = f.$SlideHeight || mc, Wb = f.$SlideSpacing,
            Bb = K + Wb, Cb = J + Wb, bc = gb & 1 ? Bb : Cb, u = b.min(f.$Cols, r), hb, x, L, Ab, S = [], Qb, Sb, Ob,
            dc, Fc, P, E = f.$PauseOnHover, pc = f.$AutoPlayInterval, Vb = f.$SlideDuration, rb, ub, fb, Rb = u < r,
            D = Rb ? f.$Loop : 0, Y, M, F = 1, O, B, R, vb = 0, wb = 0, H, bb, eb, Eb, w, U, z, Tb = new rc, Z, Lb = [];
        P = f.$AutoPlay;
        o.Jb = fc;
        jc();
    ...
    g.$JssorThumbnailNavigator$ = function (g, C) {
        ...
        l.Gc = function (F, C) {
            if (!x) {
                ...
                q = -1;
                p = b.min(p, C.length);
                var j = d.$Orientation & 1, m = v + (v + r) * (e - 1) * (1 - j), l = u + (u + s) * (e - 1) * j,
                    o = m + (m + r) * (p - 1) * j, n = l + (l + s) * (p - 1) * (1 - j);
                a.z(f, "absolute");
                a.ib(f, "hidden");
    ...
    g.$JssorCaptionSlider$ = function (h, f, i) {
        ...
        function g(p, h, f) {
            ...
            function m(w, c, z) {
                var g = {$Easing: c.$Easing, $Round: c.$Round, $During: c.$During, $Reverse: f && !z}, m = w,
                    r = a.Yc(w), k = a.l(m), j = a.m(m), y = a.l(r), x = a.m(r), h = {}, e = {}, i = c.$ScaleClip || 1;
                ...
                if (c.$Zoom || c.$Rotate) {
                    ...
                    var s = {$Top: 0, $Right: k, $Bottom: j, $Left: 0}, v = a.p({}, s), d = v.wb = {}, u = c.$Clip & 4,
                        p = c.$Clip & 8, t = c.$Clip & 1, q = c.$Clip & 2;
                    if (u && p) {
                        d.$Top = j / 2 * i;
                        d.$Bottom = -d.$Top
    ...
    g.$JssorCaptionSlideo$ = function (n, g, m) {
        ...
        function r(c, e, b) {
            a.c(e, function (f) {
                var e = j(f), g = {$Easing: a.Lc(e.$Easing), xc: a.Pc(), $OriginalWidth: b.N, $OriginalHeight: b.P},
