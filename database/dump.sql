...
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'API입력' ROW_FORMAT = Compact;
...
INSERT INTO `tb_api_input` VALUES (8, 2, 'profile_url', 'String', '', '필수아님', '회원 사진', 0, '');
...
INSERT INTO `tb_api_input` VALUES (14, 5, 'dev_type', 'String', '', '필수', 'android,web', 0, '');
INSERT INTO `tb_api_input` VALUES (15, 9, 'access_token', 'String', '', '필수', '접근 token', 0, '');
INSERT INTO `tb_api_input` VALUES (16, 9, 'uploadfile', 'File', '', '필수', 'backup file ', 0, '');
...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'API리스트' ROW_FORMAT = Compact;
...
INSERT INTO `tb_api_list` VALUES (5, 'common/app_info', '공통 정보 얻기', 'common/app_info', 'POST', 1, '', '', 1);
INSERT INTO `tb_api_list` VALUES (6, 'push/push_list', 'Push Notification List', 'push/push_list', 'POST', 1, '', '', 1);
INSERT INTO `tb_api_list` VALUES (8, 'common/upload_file', 'File Upload', 'common/upload_file', 'POST', 1, '', '', 1);
INSERT INTO `tb_api_list` VALUES (9, 'user/backup', '회원 자료를 백업', 'user/backup', 'POST', 1, '', '', 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'API출력' ROW_FORMAT = Compact;
...
INSERT INTO `tb_api_output` VALUES (15, 9, 'url', 'String', '', '필수', 'backup url', 0, '');
...
CREATE TABLE `tb_notice`  (
  `uid` int(11) NOT NULL AUTO_INCREMENT COMMENT '인덱스',
  `title` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '타이틀',
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '내용',
  `image_url` varchar(2083) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '이미지',
  `edt_time` datetime(0) NULL DEFAULT current_timestamp(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '편집시간',
  `reg_time` datetime(0) NULL DEFAULT current_timestamp(0) COMMENT '등록시간',
  `admin_uid` int(11) NULL DEFAULT NULL COMMENT '작성자-어드민 아이디',
  `status` int(11) NULL DEFAULT 1 COMMENT '상태',
  PRIMARY KEY (`uid`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '공지사항 테이블' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of tb_notice
-- ----------------------------
INSERT INTO `tb_notice` VALUES (1, 'Welcome', 'How are you?', 'http://192.168.0.13:9901/uploads/temp/16105604304258027.png', '2021-01-14 01:53:50', '2021-01-14 01:53:50', 1, 1);
...
-- ----------------------------
-- Records of tb_push_his
-- ----------------------------
INSERT INTO `tb_push_his` VALUES (1, 1, '2020-10-05 23:44:40', 1, 1, 'admin', '0', 'test', 'Welcome to my site!', NULL);
INSERT INTO `tb_push_his` VALUES (2, 1, '2020-10-06 09:50:53', 1, NULL, 'admin', '0', 'test', 'Welcome to my site!', NULL);
INSERT INTO `tb_push_his` VALUES (3, 1, '2020-10-06 09:58:52', 1, NULL, 'admin', '0', 'test', 'Welcome to my site!', NULL);
INSERT INTO `tb_push_his` VALUES (4, 1, '2020-10-09 23:14:49', 1, NULL, 'admin', '0', 'test', 'Welcome to my site!', '{\"count\":1}');
INSERT INTO `tb_push_his` VALUES (5, 1, '2020-10-09 23:16:15', 1, NULL, 'admin', '0', 'test', 'Welcome to my site!', '{\"count\":100}');
INSERT INTO `tb_push_his` VALUES (6, 1, '2020-10-09 23:16:43', 1, NULL, 'admin', '0', 'test', 'Welcome to my site!', '{\"count\":100}');
...
CREATE TABLE `tb_setting`  (
  ...
  `client_phone` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'Client Phone',
  `use_agreement` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT 'Agreement html text',
  PRIMARY KEY (`uid`) USING BTREE
...
-- ----------------------------
INSERT INTO `tb_setting` VALUES (1, 'AoeOKOJHNfBvcJv', 1, 'mario', 'mario', '12312', '<p>AasdASDasd</p>');
...
CREATE TABLE `tb_user`  (
  ...
  `profile_url` varchar(2083) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '회원 사진URL',
  ...
  `backup_url` varchar(2083) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '회원 backup sql',
  PRIMARY KEY (`uid`) USING BTREE
...
-- Records of tb_user
-- ----------------------------
INSERT INTO `tb_user` VALUES (1, '2020-10-04 00:10:45', 'user1@gmail.com', '123456', 'tester1', '', 2, 'c6f9ac92a992adbb6dfaff86d446b5b14ce35484', 'android', '', '2021-01-13 15:22:20', 0, 1, 'http://192.168.0.13:9901/uploads/user/16105226612708266.png');
INSERT INTO `tb_user` VALUES (2, '2020-10-04 00:26:48', 'user2@gmail.com', '123456', 'tester2', 'http://192.168.0.13:9901/uploads/temp/16020576718266783.jpg', 2, NULL, NULL, '', NULL, 1, 0, NULL);
INSERT INTO `tb_user` VALUES (3, '2020-10-04 00:30:24', 'user3@gmail.com', '123456', 'tester3', 'http://192.168.0.13:9901/uploads/temp/16020589802561760.jpg', 1, '1c4f033d28179cfb6d6a0965991bc7d8b3dc9f47', 'android', '', '2020-10-08 02:59:04', 0, 1, NULL);
INSERT INTO `tb_user` VALUES (4, '2020-10-07 16:55:58', 'user4@gmail.com', '123456', 'tester4', '', 2, '29d2ad8b1d76ef883b83fc8319cfe31574cea608', 'android', '', '2020-10-10 09:23:09', 0, 1, NULL);
INSERT INTO `tb_user` VALUES (5, '2020-10-07 17:00:37', 'user5@gmail.com', '123456', 'tester5', '', 2, 'cc6206ae81340afafd86b34a950a6bafd17cdc2d', 'android', '', '2020-10-07 17:00:37', 0, 1, NULL);
