    ...
    <div class="col-md-12">
        <div class="col-md-12">
            <div class="btn-group"  style="float: right;margin-top: 20px;">
                ...
                <a type="button" class="btn btn-success" style="font-size: 13px;" href="<?=site_url('apiManage/api_input_list')?>?id=<?=$api_idx?>">Intput 목록가기</a>
                <a type="button" class="btn btn-primary" style="font-size: 13px;" href="<?=site_url('apiManage/edit_api_output_data')?>?ai_idx=0&api_idx=<?=$api_idx?>"><i class="fa fa-plus"></i>&nbsp;Output변수 추가</a>
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function(){
        ...
        $('#page_title').html("<?=$api_name?>:Output목록");
    })
